...
transcription and the database works. For more information about the `kleio` notation used  for source transcriptions see: [3.1 Kleio Notation Reference](Kleio_Notation_Reference.md)
...
In this example a group names "amz1" will be matched with database class "acta".
